    ...
    <div className="container mx-auto p-4 md:p-8 max-w-7xl">
      <header className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1">Smart candidate screening & ranking</p>
        </div>
      ...
      {view === 'setup' ? (
        <div className="max-w-3xl mx-auto space-y-8">
          <div className="text-center">
            <h2 className="text-2xl font-semibold text-white">Define the job and add candidates to get started.</h2>
          </div>
          
          <JobDescriptionPanel onSubmit={handleJobSubmit} initialJob={jobDescription} />
          ...
          {isAnalyzing && (
            <div className="text-center py-6">
              <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-purple-400 text-sm animate-pulse">Analyzing resumes... This may take a moment.</p>
              </div>
            </div>
          )}
          ...
          <div className="text-center pt-4">
            <button 
              ...
              disabled={!jobDescription || rankings.length === 0 || isAnalyzing}
              className={`px-8 py-3.5 rounded-xl font-medium text-lg transition-all ${
                (!jobDescription || rankings.length === 0 || isAnalyzing)
          ...
          <div className="glass-panel h-[75vh] p-8 flex flex-col">
            <div className="flex justify-between items-end mb-6">
              <div>
                ...
                <p className="text-gray-400 text-sm mt-1">Candidates ranked by AI analysis</p>
              </div>
